...
public class Menu extends PanelTransparent {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/1.png")), "Sinh Viên", "Danh sách", "Xếp loại", "Học lực"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Điểm", "Thống kê điểm", "Bảng Điểm Lớp Học"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Quản lý chung", "Kỳ", "Môn","Ngành","Giảng Viên","Lớp Học","Đầu Điểm"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Tài khoản", "Thông tin cá nhân", "Đăng xuất"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Thoát"));
    }
